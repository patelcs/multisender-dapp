...
const STEPS = [
  ...
  },
  {
    step: "03",
    title: "Review & Send",
    desc: "Approve tokens if needed, then confirm the single transaction to distribute everything.",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 pb-20 pt-24 sm:px-6 sm:pt-32 lg:px-8 lg:pt-40">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-[var(--muted)] sm:text-xl">
              Distribute ERC20 tokens and native ETH to hundreds of addresses
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Why use <span className="gradient-text">MultiSender</span>?
            </h2>
            <p className="mt-4 text-[var(--muted)]">
              Everything you need to distribute tokens efficiently and securely.
            </p>
          </div>
      ...
      <section className="border-t border-[var(--border)]">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-[var(--muted)]">
              Three simple steps to distribute tokens.
            </p>
          </div>
      ...
      <section className="border-t border-[var(--border)] bg-[var(--card)]">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-[var(--muted)]">
              Connect your wallet and start distributing tokens in seconds.
            </p>
